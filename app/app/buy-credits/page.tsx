...
export default function BuyCreditsBetaPlaceholder() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 flex flex-col items-center justify-center p-4">
      <div className="text-center max-w-xl mx-auto space-y-6 bg-white/10 backdrop-blur-lg p-10 rounded-3xl border border-white/20">
        ...
        <p className="text-xl text-blue-300 font-semibold">
          No signups, no money, no limits.
        </p>
        <p className="text-gray-300">
          All premium features, job packs, and AI generators are currently 100% free and unlocked. We've removed our credit system during this beta phase to gather feedback!
        </p>
        <div className="pt-6">
          <Link 
            href="/dashboard" 
